...
public class Answers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if (item == R.id.meditation) {
                            ...
                            Intent intent = new Intent(Answers.this, Login.class);
                            startActivity(intent);
                        }
        ...
        if (code == 1) {
            ...
            response.setText("   First, the fact your are asking this question shows how observant your are. Second, the fact that this particular question is frequently asked shows there is still hope for the majority of Goat Sage users. The reason Goat Sage is so handsome is because when one is as intelligent as Sage Goat, they can not simply help but to be amazing in every other aspect too. ");
        } else if (code == 2) {
            ...
            response.setText("   Goat Sage benefits any of his users by providing the most up to date and relevant facts and advice for whatever the situation. He is an awesome party asset, bodyguard, and fashion advisor. He also single handedly improves the lives of many poor peoples around the world while supporting you and the aforementioned stuff. For you specifically, he can tell you when your ideas are bad, when your forgot your clothes, and where to go to get mugged by his associates.");
        } else if (code == 4) {
            title.setText("Global Goat Sage Impact?");
            response.setText("   On the global scale, Goat Sage is a major contributor to three-hundred charities and humanitarian efforts (only one of which he does not own *Ramen Noodle Co.*). Goat Sage also provides wifi to impoverished places and works closely with the big corporations to make as much money for something undisclosed to you. Goat Sage also received an Emmy Award for his efforts to help orphans in the Oceanic Islands. ");
        } else if (code == 5) {
            ...
            response.setText("   If you are asking this question, then you are missing some fundamental principles of the existence of Goat Sage in your intellect. Goat Sage is not bound by geographical positions as we are, instead he transcends them and does whatever he wants. Just think, he might even be living in your liver right now.... /n         Food for thought :)");
        }
    }//end of onCreate
